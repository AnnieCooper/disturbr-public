...
create_pred_image <- function(data, orig_data, pred_values, data_path, 
                              fill_image, plot = TRUE, output_path, out_data, 
                              out_class_raster, out_date_raster) {
  ...
  # write out value raster
  writeRaster(classified, paste(output_path, out_class_raster, sep = ''), overwrite = T)
  ...
  # write out date raster
  writeRaster(classified, paste(output_path, out_date_raster, sep = ''), overwrite = T)
